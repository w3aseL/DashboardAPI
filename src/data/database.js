...
const spotifySQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "spotify-db.sqlite"),
...
const twitterSQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "twitter-db.sqlite"),
  logging: (msg) => DBLogger.info(msg)
})
...
const userSQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "user-db.sqlite"),
  logging: (msg) => DBLogger.info(msg)
})
...
const portfolioSQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "portfolio-db.sqlite"),
  logging: (msg) => DBLogger.info(msg)
})
...
const twitchSQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "twitch-db.sqlite"),
  logging: (msg) => DBLogger.info(msg)
})
...
const destinySQL = new Sequelize({
  dialect: "sqlite",
  storage: path.join(process.cwd(), "storage", "destiny-db.sqlite"),
  logging: (msg) => DBLogger.info(msg)
})
